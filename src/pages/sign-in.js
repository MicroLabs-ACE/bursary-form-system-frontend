  ...
  const initiateGoogle = async () => {
    ...
    try {
      const response = await axios.get(
        "https://bursary-form-system-backend.onrender.com/auth/google"
      );
  ...
  return (
    <div className="form-wrapper">
      ...
      <div className="sign-in ">
        ...
        />
        <button className="variant-a" onClick={sendOTP}>
          {submitting ? "Please wait..." : "Send OTP code"}
        </button>
        <div className="sect-break">
          <p>OR</p>
        </div>
        <button className="variant-b" onClick={initiateGoogle}>
